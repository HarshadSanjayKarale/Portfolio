...
const HeaderIntro: React.FC = () => {
  ...
  return (
    <section
      ...
      id="home"
    >
      <RadialGradient scale="scale-y-125" opacity="opacity-60" />
      ...
      />
      <h1 className="text-4xl lg:text-5xl xl:text-6xl max-sm:text-5xl">
        {headerIntroData.title.en}
        <span className="wave text-7xl max-sm:text-5xl">&#128075;&#127997;</span>
      </h1>
