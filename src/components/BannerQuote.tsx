...
const BannerQuote: React.FC<BannerProps> = ({
  ...
  useQuoteAnimation(`.${containerType}-container h5`);
      ...
      <section className="quote-banner relative overflow-x-clip z-[1]">
        ...
        >
          <div className="quote-container rotate-3 flex items-center flex-col justify-center p-56 max-lg:p-20 ">
            <h2 className="text-[--white] text-center text-6xl mb-16 mt-16 max-lg:text-[2.5rem] max-lg:mb-8 max-lg:leading-tight font-light italic tracking-wide">
              {quoteTranslation}
            </h2>
            <p className="text-[--grey] text-lg">{quotesData[0].author}</p>
          </div>
        </div>
      </section>
    </React.Fragment>
      ...
      <section className="quote-banner relative overflow-x-clip min-[1921px]:px-96">
        <div className="h-[50vh] -rotate-3 flex justify-center items-center scale-110">
          <div className="statement-container rotate-3 flex items-center flex-col justify-center p-56 max-lg:p-20">
            <h2 className="text-[--black] text-center text-6xl mb-16 mt-16 max-lg:text-[2.5rem] max-lg:mb-8 max-lg:leading-tight font-light italic tracking-wide">
              {quoteTranslation}
            </h2>
          </div>
        </div>
